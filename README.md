...
C編集、IndexedDB保存、利用者ソース1本のブラウザ内ビルド、GCC原文診断、1,261,568
...
[`docs/IDE実装_20260822.md`](docs/IDE実装_20260822.md)を参照。

一方、コンパイルエラーの日本語注釈、1クリック復帰、キーボード入力の作り込み、
Cache Storage・資産分割・更新・オフラインを含む配布方式、m68kアセンブラのハイライト、
